...
\tikzstyle{chapter} = [draw, rectangle, minimum width=9cm, minimum height=1.5cm, align=center]
\tikzstyle{section} = [draw, rectangle, minimum width=2cm, minimum height=1cm, align=center]
