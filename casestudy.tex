...
\begin{frame}
    ...
    \begin{table}
        ...
        \resizebox{10cm}{!}{
            ...
            automatic & \alert<2>{12.9} & 11.79 & 10.45 & \alert<2>{12.95} & \alert<2>{12.9} \\
            \bottomrule
            \end{tabular}
        }
...
\begin{frame}
    ...
    \begin{table}
        ...
        \resizebox{10cm}{!}{
            ...
            & 10.12.2022 & 11.12.2022 & 12.12.2022 & 13.12.2022 & 14.12.2022 \\
            \midrule
            manual & 742.81 & 659.95 & 658.19 & \alert<2>{854.64} & 784.81 \\
            automatic & 832.15 & 674.58 & 670.92 & \alert<2>{1065.63} & 933.17 \\
            \bottomrule
            \end{tabular}
        }
